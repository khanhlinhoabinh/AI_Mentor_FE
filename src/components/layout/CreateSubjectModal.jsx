...
import styles from "../../styles/CreateSubjectModal.module.css"; // chỉnh path nếu cần

export default function CreateSubjectModal({ onClose }) {
    ...
    <div className={styles.overlay} onClick={handleOverlayClick}>
      <div className={styles.modal}>
        ...
        <p className={styles.subtitle}>
          Hãy tạo môn học đầu tiên để bắt đầu hành trình
          <br />
          học tập cùng <strong className={styles.brand}>AI Mentor</strong> nhé!
        </p>
